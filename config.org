...
#+begin_src emacs-lisp :tangle init.el
  (add-plugin "consult")
  (autoloads '(consult-buffer consult-line consult-goto-line consult-outline consult-mark consult-imenu consult-imenu-multi consult-compile-error) "consult" nil t)
